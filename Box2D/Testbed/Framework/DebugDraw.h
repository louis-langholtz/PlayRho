...
public:
	...
	void DrawCircle(const b2Vec2& center, b2Float radius, const b2Color& color);

	void DrawSolidCircle(const b2Vec2& center, b2Float radius, const b2Vec2& axis, const b2Color& color);
