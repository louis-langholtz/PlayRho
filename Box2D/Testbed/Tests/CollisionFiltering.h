...
public:
	CollisionFiltering()
	{
		...
		Body* body1 = m_world->Create(triangleBodyDef);
		...
		Body* body2 = m_world->Create(triangleBodyDef);
		...
		Body* body3 = m_world->Create(boxBodyDef);
		...
		Body* body4 = m_world->Create(boxBodyDef);
		...
		Body* body5 = m_world->Create(circleBodyDef);
		...
		Body* body6 = m_world->Create(circleBodyDef);
