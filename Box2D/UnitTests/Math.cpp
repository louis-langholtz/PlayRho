...
{
	const auto velA = Velocity{Vec2(+1, +4), 3.2f * RadianPerSecond};
	const auto velB = Velocity{Vec2(+3, +1), 0.4f * RadianPerSecond};
...
TEST(Math, GetPosition)
{
	...
	const auto oldPos = Position{Vec2{x, y}, 0.0f * Radian};
