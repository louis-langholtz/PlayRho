...
TEST(Simplex, Get2_rot_plus_45)
{
	...
	const auto va1 = Rotate(va0, Rot{DegreesToRadians(45)});
	const auto vb1 = Rotate(vb0, Rot{DegreesToRadians(45)});
	const auto ia1 = SimplexVertex::size_type{4};
	const auto ib1 = SimplexVertex::size_type{1};
	const auto sv1 = SimplexVertex{va1, ia1, vb1, ib1};
...
TEST(Simplex, Get2_rot45_half)
{
	...
	const auto va1 = Rotate(va0, Rot{DegreesToRadians(45)}) / 2; // Vec2{-13.081475, 10.253049}
	const auto vb1 = Rotate(vb0, Rot{DegreesToRadians(45)}) / 2; // Vec2{316.4303, 320.67291}
