...
TEST(Angle, GetRevRotationalAngle)
{
	...
	EXPECT_NEAR(double(GetRevRotationalAngle(RealNum{100.0f} * Degree, RealNum{110.0f} * Degree) / Degree), double(10), 0.0001);
	EXPECT_NEAR(double(GetRevRotationalAngle( RealNum{10.0f} * Degree, RealNum{0} * Degree) / Degree), double(350), 0.0001);
