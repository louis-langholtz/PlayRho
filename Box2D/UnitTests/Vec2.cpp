...
TEST(Vec2, ByteSizeIs_8_or_16)
{
	...
	{
		case  4: EXPECT_EQ(sizeof(Vec2), size_t(8)); break;
		case  8: EXPECT_EQ(sizeof(Vec2), size_t(16)); break;
		case 16: EXPECT_EQ(sizeof(Vec2), size_t(32)); break;
		default: FAIL(); break;
	}
}
...
TEST(Vec2, Rotate)
{
	...
	EXPECT_EQ(round(v01), round(Rotate(v10, UnitVec2{RealNum{90.0f} * Degree})));

	EXPECT_EQ(round(Vec2{22, 30}), round(Rotate(Vec2{22, 30}, UnitVec2{RealNum{0} * Degree})));
	EXPECT_EQ(round(Vec2{22, 30}, 1000), round(Rotate(Vec2{22, 30}, UnitVec2{RealNum{360.0f} * Degree}), 1000));
	EXPECT_EQ(round(-Vec2{22, 30}, 1000), round(Rotate(Vec2{22, 30}, UnitVec2{RealNum{180.0f} * Degree}), 1000));
}
