...
TEST(WorldManifold, GetWorldManifoldForCirclesTouchingManifold)
{
	...
	const auto xfA = Transformation{Vec2{4-1, 0}, 0_deg};
	const auto xfB = Transformation{Vec2{4+1, 0}, 0_deg};
...
{
	const auto manifold = Manifold::GetForCircles(Vec2{0, 0}, Manifold::Point{Vec2{0, 0}});
	const auto xfA = Transformation{Vec2{7-0.5, 0}, 0_deg};
	const auto xfB = Transformation{Vec2{7+0.5, 0}, 0_deg};
	const auto rA = float_t(1);
	const auto rB = float_t(1);
	const auto wm = GetWorldManifold(manifold, xfA, rA, xfB, rB);
...
{
	const auto manifold = Manifold::GetForCircles(Vec2{0, 0}, Manifold::Point{Vec2{0, 0}});
	const auto xfA = Transformation{Vec2{3-0, 0}, 0_deg};
	const auto xfB = Transformation{Vec2{3+0, 0}, 0_deg};
	const auto rA = float_t(1);
	const auto rB = float_t(1);
	const auto wm = GetWorldManifold(manifold, xfA, rA, xfB, rB);
