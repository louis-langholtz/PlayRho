...
b2ChainAndPolygonContact::b2ChainAndPolygonContact(b2Fixture* fixtureA, child_count_t indexA,
												   b2Fixture* fixtureB, child_count_t indexB)
...
b2Manifold b2ChainAndPolygonContact::Evaluate(const b2Transform& xfA, const b2Transform& xfB)
{
	...
	return b2CollideShapes(edge, xfA, *static_cast<b2PolygonShape*>(m_fixtureB->GetShape()), xfB);
}
