...
float32 b2PrismaticJoint::GetLowerLimit() const noexcept
{
	return m_lowerTranslation;
}

float32 b2PrismaticJoint::GetUpperLimit() const noexcept
{
...
void b2PrismaticJoint::SetMotorSpeed(float32 speed) noexcept
{
	m_bodyA->SetAwake();
	m_bodyB->SetAwake();
	m_motorSpeed = speed;
...
void b2PrismaticJoint::SetMaxMotorForce(float32 force) noexcept
{
	m_bodyA->SetAwake();
	m_bodyB->SetAwake();
...
float32 b2PrismaticJoint::GetMotorForce(float32 inv_dt) const noexcept
{
