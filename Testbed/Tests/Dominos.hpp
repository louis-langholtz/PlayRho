...
public:
    ...
    Dominos()
    {
        ...
        Attach(GetWorld(), b1, CreateShape(GetWorld(), EdgeShapeConf(Vec2(-40.0f, 0.0f) * 1_m, Vec2(40.0f, 0.0f) * 1_m)));
        ...
        BodyID b3;
        {
            ...
            Attach(GetWorld(), b3, CreateShape(GetWorld(), PolygonShapeConf{}.UseDensity(10_kgpm2).SetAsBox(6_m, 0.125_m)));
        }
        ...
        BodyID b4;
        {
            ...
            Attach(GetWorld(), b4, CreateShape(GetWorld(), PolygonShapeConf{}.UseDensity(10_kgpm2).SetAsBox(0.25_m, 0.25_m)));
        }
        ...
        BodyID b6;
        {
            ...
            Attach(GetWorld(), b6, CreateShape(GetWorld(), PolygonShapeConf(1_m, 0.1_m).UseDensity(30_kgpm2)));
        }
