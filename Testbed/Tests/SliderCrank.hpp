    ...
    SliderCrank()
    {
...

        {
            ...
            // Define crank.
            {
                ...
                body->CreateFixture(PolygonShapeConf{}.SetDensity(2_kgpm2).SetAsBox(0.5_m, 2_m));
            ...
            // Define follower.
            {
                ...
                const auto body = m_world.CreateBody(bd);
                body->CreateFixture(PolygonShapeConf{}.SetDensity(2_kgpm2).SetAsBox(0.5_m, 4_m));
            ...
            // Define piston
            {
                ...
                const auto body = m_world.CreateBody(bd);
                body->CreateFixture(PolygonShapeConf{}.SetDensity(2_kgpm2).SetAsBox(1.5_m, 1.5_m));
            ...
            // Create a payload
            {
                ...
                m_world.CreateBody(bd)->CreateFixture(PolygonShapeConf{}.SetDensity(2_kgpm2).SetAsBox(1.5_m, 1.5_m));
            }
        }
