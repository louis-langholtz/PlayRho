...
public:
    ...
    VerticalStack()
    {
        ...
        m_world.CreateFixture(ground, Shape{EdgeShapeConf{Vec2(20.0f, 0.0f) * 1_m, Vec2(20.0f, 20.0f) * 1_m}});
    ...
    BodyID m_bullet;
    Shape m_bulletshape = Shape{DiskShapeConf{}.UseRadius(0.25_m).UseDensity(20_kgpm2).UseRestitution(Real(0.05))};
};
