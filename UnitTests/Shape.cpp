...
TEST(Shape, types)
{
    ...
    EXPECT_EQ(GetTypeID(Rectangle<Geometry::Constant, 1,1>{}), GetTypeID(Rectangle<Geometry::Constant, 1,1>{}));
    ...
    EXPECT_EQ(Shape(Rectangle<Geometry::Constant, 1,1>{}), Shape(Rectangle<Geometry::Constant, 1,1>{}));
