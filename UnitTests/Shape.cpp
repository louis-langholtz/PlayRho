...
TEST(Shape, types)
{
    ...
    EXPECT_EQ(GetTypeID(Rectangle<Resizable::No, 1,1>{}), GetTypeID(Rectangle<Resizable::No, 1,1>{}));
    ...
    EXPECT_EQ(Shape(Rectangle<Resizable::No, 1,1>{}), Shape(Rectangle<Resizable::No, 1,1>{}));
