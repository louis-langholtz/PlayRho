...
TEST(BroadPhase, Traits)
{
    EXPECT_TRUE(std::is_default_constructible<BroadPhase>::value);
    EXPECT_FALSE(std::is_nothrow_default_constructible<BroadPhase>::value);
    EXPECT_FALSE(std::is_trivially_default_constructible<BroadPhase>::value);
    
    EXPECT_TRUE(std::is_constructible<BroadPhase>::value);
    EXPECT_FALSE(std::is_nothrow_constructible<BroadPhase>::value);
    EXPECT_FALSE(std::is_trivially_constructible<BroadPhase>::value);
    
    EXPECT_TRUE(std::is_copy_constructible<BroadPhase>::value);
    EXPECT_FALSE(std::is_nothrow_copy_constructible<BroadPhase>::value);
    EXPECT_FALSE(std::is_trivially_copy_constructible<BroadPhase>::value);
    
    EXPECT_TRUE(std::is_copy_assignable<BroadPhase>::value);
    EXPECT_FALSE(std::is_nothrow_copy_assignable<BroadPhase>::value);
    EXPECT_FALSE(std::is_trivially_copy_assignable<BroadPhase>::value);
    
    EXPECT_TRUE(std::is_destructible<BroadPhase>::value);
    EXPECT_TRUE(std::is_nothrow_destructible<BroadPhase>::value);
    EXPECT_FALSE(std::is_trivially_destructible<BroadPhase>::value);
}
...
TEST(BroadPhase, CreateAndDestroyProxy)
{
    ...
    EXPECT_EQ(boo.GetAABB(pid), aabb);
