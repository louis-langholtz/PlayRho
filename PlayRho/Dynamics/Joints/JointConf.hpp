...
template <class T> struct JointBuilder : JointConf
{
    /// @brief Value type.
    using value_type = T;
...
template <typename T> constexpr auto IsLimitEnabled(const T &conf) noexcept -> decltype(std::declval<T>().enableLimit)
{
...
template <typename T> constexpr auto GetLength(const T &conf) noexcept -> decltype(std::declval<T>().length)
{
    return conf.length;
}

template <typename T> constexpr auto GetMaxForce(const T &conf) noexcept -> decltype(std::declval<T>().maxForce)
{
    return conf.maxForce;
}

template <typename T> constexpr auto GetMaxTorque(const T &conf) noexcept -> decltype(std::declval<T>().maxTorque)
{
    return conf.maxTorque;
}

template <typename T> constexpr auto GetRatio(const T &conf) noexcept -> decltype(std::declval<T>().ratio)
{
    return conf.ratio;
}

template <typename T> constexpr auto GetDampingRatio(const T &conf) noexcept -> decltype(std::declval<T>().dampingRatio)
{
...
template <typename T> constexpr auto GetLinearOffset(const T &conf) noexcept -> decltype(std::declval<T>().linearOffset)
{
    return conf.linearOffset;
}

template <typename T> constexpr auto GetLimitState(const T &conf) noexcept -> decltype(std::declval<T>().limitState)
{
...
template <typename T> constexpr auto GetLocalAnchorA(const T &conf) noexcept -> decltype(std::declval<T>().localAnchorA)
{
    return conf.localAnchorA;
}

template <typename T> constexpr auto GetLocalAnchorB(const T &conf) noexcept -> decltype(std::declval<T>().localAnchorB)
{
    return conf.localAnchorB;
}

template <typename T> constexpr auto GetLocalXAxisA(const T &conf) noexcept -> decltype(std::declval<T>().localXAxisA)
{
    return conf.localXAxisA;
}

template <typename T> constexpr auto GetLocalYAxisA(const T &conf) noexcept -> decltype(std::declval<T>().localYAxisA)
{
    return conf.localYAxisA;
}

template <typename T> constexpr auto GetFrequency(const T &conf) noexcept -> decltype(std::declval<T>().frequency)
{
    return conf.frequency;
}

template <typename T> constexpr auto IsMotorEnabled(const T &conf) noexcept -> decltype(std::declval<T>().enableMotor)
{
...
template <typename T> constexpr auto GetMotorSpeed(const T &conf) noexcept -> decltype(std::declval<T>().motorSpeed)
{
...
template <typename T> constexpr auto GetAngularMass(const T &conf) noexcept -> decltype(std::declval<T>().angularMass)
{
