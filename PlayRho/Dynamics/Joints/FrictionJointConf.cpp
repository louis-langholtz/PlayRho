                          ...
                          const ConstraintSolverConf&)
        {
...

            {
                const auto exx = InvMass{
                    invMassA + invRotInertiaA * Square(GetY(object.rA)) / SquareRadian + invMassB + invRotInertiaB * Square(GetY(object.rB)) / SquareRadian};
                ...
                const auto eyy = InvMass{
                    invMassA + invRotInertiaA * Square(GetX(object.rA)) / SquareRadian + invMassB + invRotInertiaB * Square(GetX(object.rB)) / SquareRadian};
                InvMass22 K;
                GetX(GetX(K)) = exx;
                GetY(GetX(K)) = exy;
                GetX(GetY(K)) = exy;
