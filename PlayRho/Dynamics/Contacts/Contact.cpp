...
static_assert(std::is_default_constructible<Contact>::value, "Contact must be default constructible!");
...
static_assert(std::is_nothrow_destructible<Contact>::value, "Contact must be nothrow destructible!");

Contact::Contact(BodyID bA, FixtureID fA, ChildCounter iA, BodyID bB, FixtureID fB, ChildCounter iB) noexcept
