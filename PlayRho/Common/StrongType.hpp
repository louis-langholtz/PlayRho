...
template <typename T, typename Tag> class IndexingNamedType
{
  public:
...
template <typename T, typename Tag> constexpr T UnderlyingTypeImpl(IndexingNamedType<T, Tag>);

template <typename T> using UnderlyingType = decltype(UnderlyingTypeImpl(std::declval<T>()));

/// @brief Gets the underlying value.
template <typename T, typename Tag> constexpr T &UnderlyingValue(IndexingNamedType<T, Tag> &o) noexcept
{
    return static_cast<T &>(o);
}

/// @brief Gets the underlying value.
template <typename T, typename Tag> constexpr const T &UnderlyingValue(const IndexingNamedType<T, Tag> &o) noexcept
{
...
template <typename T, typename Tag> struct hash<::playrho::strongtype::IndexingNamedType<T, Tag>>
{
