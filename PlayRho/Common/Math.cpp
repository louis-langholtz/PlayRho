...
#ifdef NORMALIZE_ANGLE_VIA_FMOD_MODULO
...
#elseif NORMALIZE_ANGLE_VIA_TRUNC_MODULO // previous way
...
#elseif USE_ALMOST_FASTEST_ALGORITHM
...
//#define USE_NORMALIZATION_FOR_ANGULAR_LERP
#ifdef USE_NORMALIZATION_FOR_ANGULAR_LERP
    constexpr auto twoPi = Real(2) * Pi;
    constexpr auto rTwoPi = Real(1) / twoPi;
...
#elseif USE_GETSHORTESTDELTA_FOR_ANGULAR_LERP
