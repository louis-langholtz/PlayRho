...
LengthIndexPair FindMinSeparationForPoints(const SeparationScenario &scenario, const Transformation &xfA,
...
LengthIndexPair FindMinSeparationForFaceA(const SeparationScenario &scenario, const Transformation &xfA,
                                          const Transformation &xfB)
{
...
LengthIndexPair FindMinSeparationForFaceB(const SeparationScenario &scenario, const Transformation &xfA,
                                          const Transformation &xfB)
{
...
Length EvaluateForPoints(const SeparationScenario &scenario, const Transformation &xfA, const Transformation &xfB,
                         IndexPair indexPair)
{
...
Length EvaluateForFaceA(const SeparationScenario &scenario, const Transformation &xfA, const Transformation &xfB,
                        IndexPair indexPair)
{
    const auto normal = Rotate(scenario.axis, xfA.q);
    const auto pointA = Transform(scenario.localPoint, xfA);
...
Length EvaluateForFaceB(const SeparationScenario &scenario, const Transformation &xfA, const Transformation &xfB,
                        IndexPair indexPair)
{
    const auto normal = Rotate(scenario.axis, xfB.q);
    const auto pointB = Transform(scenario.localPoint, xfB);
                                         ...
                                         const DistanceProxy &proxyB, const Transformation &xfB)
{
    ...
    const auto type = (numIndices == 1)
                          ? SeparationScenario::e_points
                          : ((std::get<0>(indices[0]) == std::get<0>(indices[1])) ? SeparationScenario::e_faceB
                                                                                  : SeparationScenario::e_faceA);
