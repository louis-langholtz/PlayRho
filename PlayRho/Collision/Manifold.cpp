...
VertexCounterPair GetMostAntiParallelEdge(UnitVec shape0_rel_n0, const Transformation &xf0, const DistanceProxy &shape1,
                                          const Transformation &xf1, const VertexCounter2 indices1) noexcept
{
    ...
    return ((secondIdx > firstIdx) && ((firstIdx + 1) == secondIdx)) ? std::make_pair(firstIdx, secondIdx)
                       ...
                       VertexCounterPair shape1_e)
{
    ...
    const auto ie = ClipList{ClipVertex{shape1_abs_v0, GetFaceVertexContactFeature(shape0_e.first, shape1_e.first)},
...
Manifold GetManifold(bool flipped, const DistanceProxy &shape0, const Transformation &xf0, const VertexCounter idx0,
                     const DistanceProxy &shape1, const Transformation &xf1, const VertexCounter2 indices1,
                     const Manifold::Conf conf)
{
    ...
    if (GetMagnitudeSquared(shape0_abs_v0 - shape1_abs_v0) <= totalRadiusSquared)
    {
        ...
        if (!flipped) // face A
        {
            ...
            {
                return Manifold::GetForFaceA(GetFwdPerpendicular(shape0_rel_e0_dir), idx0, shape0_rel_v0,
                                             ContactFeature::e_vertex, shape1_e.first, shape1_rel_v0);
            }
        ...
        if (mustUseFaceManifold)
        {
            return Manifold::GetForFaceB(GetFwdPerpendicular(shape0_rel_e0_dir), idx0, shape0_rel_v0,
                                         ContactFeature::e_vertex, shape1_e.first, shape1_rel_v0);
        }
    ...
    else if (GetMagnitudeSquared(shape0_abs_v0 - shape1_abs_v1) <= totalRadiusSquared)
    {
        ...
        if (!flipped)
        {
            ...
            {
                return Manifold::GetForFaceA(GetFwdPerpendicular(shape0_rel_e0_dir), idx0, shape0_rel_v0,
                                             ContactFeature::e_vertex, shape1_e.second, shape1_rel_v1);
            }
    ...
    else if (GetMagnitudeSquared(shape0_abs_v1 - shape1_abs_v1) <= totalRadiusSquared)
    {
        ...
        if (!flipped)
        {
            if (mustUseFaceManifold)
            {
                return Manifold::GetForFaceA(GetFwdPerpendicular(shape0_rel_e0_dir), idx0Next, shape0_rel_v1,
                                             ContactFeature::e_vertex, shape1_e.second, shape1_rel_v1);
            }
        ...
        if (mustUseFaceManifold)
        {
            return Manifold::GetForFaceB(GetFwdPerpendicular(shape0_rel_e0_dir), idx0Next, shape0_rel_v1,
                                         ContactFeature::e_vertex, shape1_e.second, shape1_rel_v1);
        }
...
Manifold GetManifold(bool flipped, Length totalRadius, const DistanceProxy &shape, const Transformation &sxf,
                     Length2 point, const Transformation &xfm)
{
    ...
    if (maxSeparation < 0_m)
    {
        ...
        if (!flipped)
        {
            return Manifold::GetForFaceA(shape.GetNormal(indexOfMax), indexOfMax, faceCenter, ContactFeature::e_vertex,
                                         0, point);
        }
        return Manifold::GetForFaceB(shape.GetNormal(indexOfMax), indexOfMax, faceCenter, ContactFeature::e_vertex, 0,
                                     point);
    }
    ...
    if (!flipped)
    {
        return Manifold::GetForFaceA(shape.GetNormal(indexOfMax), indexOfMax, faceCenter, ContactFeature::e_vertex, 0,
                                     point);
    }
    return Manifold::GetForFaceB(shape.GetNormal(indexOfMax), indexOfMax, faceCenter, ContactFeature::e_vertex, 0,
                                 point);
...
Manifold GetManifold(Length2 locationA, const Transformation &xfA, Length2 locationB, const Transformation &xfB,
...
Manifold CollideShapes(const DistanceProxy &shapeA, const Transformation &xfA, const DistanceProxy &shapeB,
                       const Transformation &xfB, Manifold::Conf conf)
{
    ...
    const auto edgeSepA =
        do4x4 ? GetMaxSeparation4x4(shapeA, xfA, shapeB, xfB) : GetMaxSeparation(shapeA, xfA, shapeB, xfB);
    ...
    const auto edgeSepB =
        do4x4 ? GetMaxSeparation4x4(shapeB, xfB, shapeA, xfA) : GetMaxSeparation(shapeB, xfB, shapeA, xfA);
    ...
    return (edgeSepB.distance > (edgeSepA.distance + k_tol))
               ? GetManifold(true, shapeB, xfB, edgeSepB.firstShape, shapeA, xfA, edgeSepB.secondShape, conf)
               : GetManifold(false, shapeA, xfA, edgeSepA.firstShape, shapeB, xfB, edgeSepA.secondShape, conf);
}
...
#ifdef DEFINE_GET_MANIFOLD
Manifold GetManifold(const DistanceProxy &proxyA, const Transformation &transformA, const DistanceProxy &proxyB,
                     const Transformation &transformB)
{
    ...
    if (uniqA < uniqB)
    {
        ...
        case 1: // uniqB must be 2 or 3
        {
            ...
            const auto mp0 = Manifold::Point{proxyA.GetVertex(a_indices_array[0]), ContactFeature{
    ...
    else if (uniqB < uniqA)
    {
        ...
        case 1: // uniqA must be 2 or 3
        {
            ...
            const auto mp0 = Manifold::Point{
                ...
                ContactFeature{ContactFeature::e_face, a_idx0, ContactFeature::e_vertex, b_indices_array[0]}};
